...
Route::get('/health', function () {
    return response()->json([
        ...
        'version' => config('app.version', '1.0.9'),
    ]);
});
...
Route::middleware(['super.admin.auth'])->prefix('super-admin')->group(function () {
    ...
    Route::post('/subscription-invoices/{id}/mark-paid', [SuperAdminController::class, 'markInvoicePaid']);
    ...
    Route::get('/sms-resolve-source', [SuperAdminController::class, 'smsResolveSource']);
    Route::post('/sms-heal-gateway', [SuperAdminController::class, 'healSmsGateway']);
...
Route::middleware(['super.admin.auth'])->prefix('super-admin/db')->group(function () {
    ...
    Route::post('/{table}', [GenericCrudController::class, 'store'])
        ->where('table', GenericCrudController::routeTablePattern());
    Route::put('/{table}', [GenericCrudController::class, 'update'])
        ->where('table', GenericCrudController::routeTablePattern());
