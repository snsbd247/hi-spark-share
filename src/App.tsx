...
const CustomerConnectionHealth = lazy(() => import("@/pages/portal/CustomerConnectionHealth"));
          ...
          <AuthProvider>
            ...
            <SuperAdminProvider>
              ...
              <Routes>
                ...
                <Route path="/portal/connection-health" element={<CustomerProtectedRoute><CustomerConnectionHealth /></CustomerProtectedRoute>} />
